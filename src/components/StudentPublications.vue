  ...
  <div class="admin-container">
    <div class="layout-wrapper">
      <nav class="sidebar">
        ...
        <ul class="nav-list">
          <!-- Student Home -->
          <li class="nav-item" @click="setPage('studenthome')">
            <img
                loading="lazy"
                src="@/assets/home.png"
          ...
          <!-- Student Teaching -->
          <li class="nav-item" @click="setPage('studentteaching')">
            <img
                loading="lazy"
                src="@/assets/book.png"
          ...
          <li class="nav-item active" @click="setPage('studentpublications')">
            <img
                loading="lazy"
          ...
          <!-- Student Research -->
          <li class="nav-item" @click="setPage('studentresearch')">
            <img
                loading="lazy"
...
export default {
  ...
  methods: {
    ...
    saveContent() {
      alert("Saved!"); // Replace with actual save logic later
    }
  }
};
</script>
