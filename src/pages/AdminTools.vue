    ...
    <div class="layout-wrapper">
      <nav class="sidebar">
        ...
        <ul class="nav-list">
          ...
          <!-- Collapsible sub-menu for Public Work -->
           <ul v-if="isMenuVisible" class="sub-menu">
            ...
            <ul v-if="isMentorMenuVisible" class="sub-menu"> 
              <li class="nav-item" @click="$router.push('/admin-mentoringfaculty')">
                <img
                  loading="lazy"
                ...
                />
              Faculty</li>
              <li class="nav-item" @click="$router.push('/admin-mentoringstudents')">
                <img
                  loading="lazy"
          ...
          <!-- Admin Tools -->
          <li class="nav-item active" @click="$router.push('/admintools')">
            <img
              loading="lazy"
          ...
          <!-- Admin Users -->
          <li class="nav-item" @click="$router.push('/adminusers')">
            <img
              loading="lazy"
              src="@/assets/user.png"
