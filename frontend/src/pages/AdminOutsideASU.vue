  ...
  setup() {
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await axios.get("https://asu-capstone-backend.onrender.com/api/outsideasu");
  ...
  methods: {
    ...
    async submitContent() {
      ...
      try {
        ...
        if (this.selectedContentId) {
          ...
          response = await axios.put(`${backendUrl}/api/outsideasu/${this.selectedContentId}`, { content });
          console.log("✅ Content Updated:", response.data);
          alert("Content updated successfully!");
        } else {
          // If creating new content
          response = await axios.post(`${backendUrl}/api/outsideasu`, { content });
    ...
    async deleteContent(contentId) {
      ...
      try {
        ...
        await axios.delete(`${backendUrl}/api/outsideasu`, { data: { id: contentId } });
