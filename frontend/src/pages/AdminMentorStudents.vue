  ...
  setup() {
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await axios.get("https://asu-capstone-backend.onrender.com/api/mentorstudents");
  ...
  methods: {
    ...
    async submitContent() {
      ...
      try {
        ...
        if (this.selectedContentId) {
          ...
          response = await axios.put(`${backendUrl}/api/mentorstudents/${this.selectedContentId}`, { content });
          console.log("✅ Content Updated:", response.data);
          alert("Content updated successfully!");
        } else {
          // If creating new content
          response = await axios.post(`${backendUrl}/api/mentorstudents`, { content });
    ...
    async deleteContent(contentId) {
      ...
      try {
        ...
        await axios.delete(`${backendUrl}/api/mentorstudents`, { data: { id: contentId } });
