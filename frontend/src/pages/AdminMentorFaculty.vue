  ...
  <div class="admin-container">
    <div class="layout-wrapper">
      ...
      <main class="main-content">
        <header class="header">
          <h1 class="page-title">Faculty Mentoring</h1>
  ...
  setup() {
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await axios.get("https://asu-capstone-backend.onrender.com/api/mentorfaculty");
  ...
  methods: {
    ...
    async submitContent() {
      ...
      try {
        ...
        if (this.selectedContentId) {
          ...
          response = await axios.put(`${backendUrl}/api/mentorfaculty/${this.selectedContentId}`, { content });
          console.log("✅ Content Updated:", response.data);
          alert("Content updated successfully!");
        } else {
          // If creating new content
          response = await axios.post(`${backendUrl}/api/mentorfaculty`, { content });
    ...
    async deleteContent(contentId) {
      ...
      try {
        ...
        await axios.delete(`${backendUrl}/api/mentorfaculty`, { data: { id: contentId } });
