  ...
  setup() {
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await axios.get("https://asu-capstone-backend.onrender.com/api/tools");
  ...
  methods: {
    ...
    async submitContent() {
      ...
      try {
        ...
        if (this.selectedContentId) {
          ...
          response = await axios.put(`${backendUrl}/api/tools/${this.selectedContentId}`, { content });
          console.log("✅ Content Updated:", response.data);
          alert("Content updated successfully!");
        } else {
          // If creating new content
          response = await axios.post(`${backendUrl}/api/tools`, { content });
    ...
    async deleteContent(contentId) {
      ...
      try {
        ...
        await axios.delete(`${backendUrl}/api/tools`, { data: { id: contentId } });
